...
isbn:  0374601178 # use ISBN to fetch cover (if no `olid` is provided, dashes are optional)
categories: hacking computer-science phishing history
tags: top-100
buy_link: https://www.amazon.com/Fancy-Bear-Goes-Phishing-Extraordinary/dp/0374601178
started: 
finished: 
released: 2023
stars: 
