---
layout: book-review
title: Existential Flourishing: A Phenomenology of the Virtues
author: Irene McMullen
cover: 
olid: # use Open Library ID to fetch cover (if no `cover` is provided)
isbn: 1108471668 # use ISBN to fetch cover (if no `olid` is provided, dashes are optional)
categories: philosophy ethics self-help novels phenomenology
tags: top-100
buy_link: https://www.amazon.com/Existential-Flourishing-Phenomenology-Irene-McMullin/dp/1108471668
started: 
finished: 
released: 2019
stars: 5
