...
isbn:  9781593279189 # use ISBN to fetch cover (if no `olid` is provided, dashes are optional)
categories: computer-science manual
tags: 
buy_link: https://nostarch.com/powershellsysadmins
started: 
finished: 
released: 2020
stars: 
