---
layout: book-review
title: Reset: Reclaiming the Internet for Civil Society (The CBC Massey Lectures)
author: Ronald J. Deibert
cover: 
olid: # use Open Library ID to fetch cover (if no `cover` is provided)
isbn:  1487008082 # use ISBN to fetch cover (if no `olid` is provided, dashes are optional)
categories: computer-science history inteligence hacking 
tags: top-100
buy_link: https://www.amazon.com/Reset-Reclaiming-Internet-Civil-Society/dp/1487008082
started: 
finished: 
released: 2020
stars: 
